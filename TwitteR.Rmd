...
```{r, echo= FALSE}
api_key <- "gCQJ0ZlUetRWLz7w5muzoEP7f"
api_secret <- "UlXO7peCRiAz5Hsfa50Q6xaD0pn7fuL4QFfNxPPQfP1oiSQBls"
token <- "51792859-cGCU5p2AEA4UbmUOgpFixzSomJFEHj2KuDCnYB3FA"
token_secret <- "Nz5L7AmgvKecROpqsZAAWdjmSX0ZqZneGYN4YtBwO5Kwg"
```
